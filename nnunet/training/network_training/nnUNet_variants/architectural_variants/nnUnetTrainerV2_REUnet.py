...
from nnunet.training.network_training.nnUNet_variants.architectural_variants.nnUNetTrainerV2_ResencUNet\
    import nnUNetTrainerV2_ResencUNet
from nnunet.utilities.nd_softmax import softmax_helper


class nnUNetTrainerV2_REUNet(nnUNetTrainerV2_ResencUNet):
