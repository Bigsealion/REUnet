...
from nnunet.inference.predict_sam import predict_and_segment_ability_map_from_folder
...
def main():
    ...
    parser.add_argument('--mask_dir', default=None, required=False,
                        help='True mask dir for SAM calculate. If used, SAM will be calculated by this, '
                             'else will calculate SAM with predicted mask (i.e., self-evaluation)')
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        predict_and_segment_ability_map_from_folder(
            model_folder_name, input_folder, lowres_output_folder, folds, False,
    ...
    predict_and_segment_ability_map_from_folder(
        model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
